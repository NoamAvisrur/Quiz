app.config(function($routeProvider) {
    ...
    .when("/1", {
        template : `<div ng-controller="q1 as q">
                        ...
                        <a href="#!2" class="next_button">next</a>
                    </div>`,
        controller : "q1"
    })
    .when("/2", {
        template : `<div ng-controller="q2 as q">
                        ...
                        <a href="#!3" class="next_button">next</a>
                    </div>`,
        controller : "q2"
    })
    .when("/3", {
        template : `<div ng-controller="q3 as q">
                        ...
                        <a href="#!4" class="next_button">next</a></div>
                    </div>`,
       controller : "q3"
    })
    .when("/4", {
        template : `<div ng-controller="q4 as q">
                      <div class="progres_bar">
                       ...
                       <a href="#!5" class="next_button">next</a></div>
                    </div>`,
       controller : "q4"
    })
    .when("/5", {
        template : `<div ng-controller="q5 as q">
                     ...
                     <button ng-click="ctrl.submit()" class="submit_button">submit</button></div>`,
       controller : "q5"
    })    
    .otherwise({
